...
$notification = $view->panel()
    ...
    ->insert($view->fieldset()->setAttribute('template',$T('FaxServer_Notification_Title'))
        ->insert($view->textInput('SendTo')->setAttribute('placeholder', $view['DefaultSendTo']))
    )
...
$extra = $view->panel()
    ...
    ->insert($view->fieldsetSwitch('PrintReceived', 'enabled', $view::FIELDSETSWITCH_CHECKBOX | $view::FIELDSETSWITCH_EXPANDABLE)
